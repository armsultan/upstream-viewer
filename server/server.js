...
// And finally, setting the engine to understand the .hbs extension is to be
// interpretted by our view engine.
app.set('view engine', '.hbs');

// here we are telling the express web server to set the static resource folder
// to 'public'. This is good practice to do so we know where we can put files
// that will not change. This is where the pictures, CSS, svgs, fonts and more
// live.
